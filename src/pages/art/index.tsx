  ...
  return (
    <Container>
      ...
      <main className="w-full bg-aqua text-white rounded-lg p-6 my-4">
        ...
        <a
          href={`https://api.whatsapp.com/send/?phone=%2B5521996710902&text&type=phone_number&app_absent=0&text=Olá vi essa pintura ${art?.name} no site e fiquei interessado!`}
