...
@Component({
  ...
  styles: [`
    ...
    .order-id { font-weight: 600; opacity: 0.7; margin-right: 0.5rem; }
    .user-info { color: var(--text-secondary); font-size: 0.85rem; }
    .status-select { padding: 0.3rem 0.6rem; border-radius: 6px; border: 1px solid var(--border-color); background: var(--input-bg); color: var(--input-text); font-size: 0.85rem; }
