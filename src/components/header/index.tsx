  ...
  return (
      ...
      <div className="w-full flex items-center justify-center h-16 bg-blue-900 drop-shadow mb-4 ">
        <header className="flex w-full items-center justify-between max-w-7xl px-4 mx-auto">
          ...
          <Link to="https://mail.google.com/mail/u/0/#inbox?compose=CllgCJNsMRPqJFJvsDnkCtCXwbqpCWmVjNwMqMPcGFNBLNMcKSMqCCgQGRmqfdhZtrCKXgwNNJq " className="text-cyan-100" title="damiaomartinspintor@gmail.com">
